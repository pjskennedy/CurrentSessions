...
(function() { this.JST || (this.JST = {}); this.JST["admins/typeahead"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        __out.push('<div class="typeahead-option">\n\n\n  <div class="media">\n    <a class="pull-left" href="#">\n      ');
      
        if (this.photos.length > 0) {
          __out.push('\n        <img class="media-object img-rounded" width="50px" height="50px" src="');
          __out.push(__sanitize(this.photos[0].photo_large));
          __out.push('">\n      ');
        } else {
...
(function() { this.JST || (this.JST = {}); this.JST["contact/email"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('\n<div class="contact-information">\n  <div class="row">\n    <div class="col-lg-3 col-lg-offset-3 col-md-4 col-md-offset-2 col-sm-5 col-sm-offset-1 col-xs-12">\n      <address>\n        <strong>Marco Carboni</strong><br>\n        Producer, Current Sessions<br>\n        Toronto, Ontario<br>\n        <a href="mailto:currentsessions@gmail.com">currentsessions@gmail.com</a>\n      </address>\n    </div>\n    <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">\n      <address>\n        <strong>Nicholas Posthumus</strong><br>\n        Director, Current Sessions<br>\n        Toronto, Ontario<br>\n        <a href="mailto:currentsessions@gmail.com">currentsessions@gmail.com</a>\n      </address>\n    </div>\n  </div>\n</div>\n<br /><br />\n<div class="page-within" id="emailer">\n  <p class="contact-heading">\n    Send us an email\n  </p>\n  <br/>\n  <form id="send-email-form">\n    <div class="email-area">\n      <div class="row">\n        <div class="col-lg-3 col-lg-offset-3 col-md-3 col-md-offset-3 col-sm-4 col-sm-offset-2 col-xs-12">\n          <div class="control-group" id="name-space">\n            <label>Name</label>\n            <input class="form-control" type="text" placeholder="Bob Bobson" id="sender-name">\n            <span class="help-block"></span>\n          </div>\n        </div>\n        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">\n          <div class="control-group" id="address-space">\n            <label>Email</label>\n            <input class="form-control" type="text" placeholder="bob.bobson@email.com" id="sender-email">\n            <span class="help-block"></span>\n          </div>\n        </div>\n      </div>\n      <div class="row">\n        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">\n          <div class="control-group" id="body-space">\n            <label>Body</label>\n            <textarea class="form-control" id="sender-body"/>\n            <span class="help-block"></span>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class="submit-button-container">\n      <button class="submit-button btn btn-primary btn-large" id="send-email-button">\n        Send email\n      </button>\n    </div>\n  </form>\n  <div class="control-group" id="response-control">\n    <label class="contact-heading response"></label>\n  </div>\n</div>\n');
...
(function() { this.JST || (this.JST = {}); this.JST["sessions/cell"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          __out.push('\n    ');
          if (first) {
            __out.push('\n\n      <div class="item active" data-route="');
            __out.push(__sanitize(this.url_route));
            __out.push('" > \n        <img src="');
            __out.push(__sanitize(photo.photo_large));
            __out.push('" data-id="');
...
(function() { this.JST || (this.JST = {}); this.JST["sessions/session"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div class="session-cell carousel slide" id="session');
...
(function() { this.JST || (this.JST = {}); this.JST["sessions/session_player"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        __out.push('?portrait=0&amp;autoplay=1" \n  width="600" \n  height="375" \n  frameborder="0"\n  webkitAllowFullScreen mozallowfullscreen allowFullScreen>\n</iframe>\n<a class="btn btn-cs btn-block" href="/');
...
(function() {
  ...
  CurrentSessions.Models.Email = (function(_super) {
...
(function() {
  ...
  CurrentSessions.Models.Video = (function(_super) {
    ...
    Video.prototype.urlRoot = '/videos';
...
(function() {
  ...
  CurrentSessions.Collections.Videos = (function(_super) {
    __extends(Videos, _super);

    function Videos() {
      _ref = Videos.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Videos.prototype.url = '/videos';
...
(function() {
  ...
  CurrentSessions.Views.AdminSessionsIndex = (function(_super) {
    __extends(AdminSessionsIndex, _super);

    function AdminSessionsIndex() {
      _ref = AdminSessionsIndex.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    AdminSessionsIndex.prototype.el = "#admin-sessions-index";

    AdminSessionsIndex.prototype.events = {
      "click #update-ordering-button": "newOrdering"
    };

    AdminSessionsIndex.prototype.initialize = function() {
      return $("#admin-sessions-container").sortable({
        revert: true,
        handle: "i.fa.fa-align-justify",
        update: function() {
          $("#admin-sessions-container").css("background-color", "#e0e0e0");
          return $("#update-ordering").removeClass("hidden");
        }
      });
    };

    AdminSessionsIndex.prototype.newOrdering = function(event) {
      return $.ajax({
        url: "/videos/ordering",
        type: "PUT",
        data: {
          ordering: _.map($("#admin-sessions-container li"), function(d) {
            return $(d).data("id");
          })
        },
        success: function() {
          $("#admin-sessions-container").css("background-color", "transparent");
          return $("#update-ordering").addClass("hidden");
        },
        error: function() {
          return alert("Something went wrong, contact web developer!");
        }
      });
    };

    return AdminSessionsIndex;
...
(function() {
  ...
  CurrentSessions.Views.AdminTypeahead = (function(_super) {
    __extends(AdminTypeahead, _super);

    function AdminTypeahead() {
      this.sessionSelected = __bind(this.sessionSelected, this);
      _ref = AdminTypeahead.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    AdminTypeahead.prototype.typeaheadTemplate = JST["admins/typeahead"];

    AdminTypeahead.prototype.events = {
      "typeahead:selected #sessions-search": "sessionSelected"
    };

    AdminTypeahead.prototype.initialize = function(attrs) {
      this.el = attrs.el;
      $("#sessions-search").typeahead({
        ...
        template: this.typeaheadTemplate,
        engine: JST
      });
      return $('.tt-hint').addClass('form-control');
    };

    AdminTypeahead.prototype.sessionSelected = function(event, data) {
      return window.location.href = "/admins/videos/" + data.id;
    };

    return AdminTypeahead;
...
(function() {
  ...
  CurrentSessions.Views.Contact = (function(_super) {
    __extends(Contact, _super);

    function Contact() {
      this.sendEmail = __bind(this.sendEmail, this);
      this.addErrorMessages = __bind(this.addErrorMessages, this);
    ...
    Contact.prototype.template = JST["contact/email"];
    ...
    Contact.prototype.addErrorMessages = function(msgs) {
      var _this = this;
      console.log(msgs);
      return _.each(_.keys(msgs), function(key) {
        return _.each(msgs[key], function(err) {
          return $("#" + key + "-space .help-block").append("<p class='text-error'>" + key + " " + err + "<p>");
        });
      });
    };

    Contact.prototype.sendEmail = function(event) {
      var _this = this;
      event.preventDefault();
      $('#send-email-button').attr('disabled', true);
      this.email = new CurrentSessions.Models.Email();
      return this.email.save({
        address: $('#sender-email').val(),
        body: $('#sender-body').val(),
        ...
        success: function() {
          ...
          return $('#send-email-button').attr('disabled', false);
        },
        error: function(email, response) {
          $(".help-block").html("");
          _this.addErrorMessages(JSON.parse(response.responseText));
...
(function() {
  ...
  CurrentSessions.Views.Player = (function(_super) {
    ...
    Player.prototype.initialize = function() {
      return $(document).keyup(function(event) {
        switch (event.keyCode) {
          case 37:
            return $("#playerCarousel").carousel('prev');
          case 39:
            return $("#playerCarousel").carousel('next');
        }
      });
    };
...
(function() {
  ...
  CurrentSessions.Views.Session = (function(_super) {
    __extends(Session, _super);

    function Session() {
      this.playerize = __bind(this.playerize, this);
      this.cellerize = __bind(this.cellerize, this);
      _ref = Session.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Session.prototype.template = JST["sessions/session"];

    Session.prototype.cell = JST["sessions/cell"];

    Session.prototype.player = JST["sessions/session_player"];

    Session.prototype.render = function(model) {
      this.model = new CurrentSessions.Models.Video(model);
      $(this.el).html(this.template(this.model.attributes));
      return this;
    };

    Session.prototype.cellerize = function() {
      this.playerMode = false;
      return $("#session" + this.model.id).html(this.cell(this.model.attributes));
    };

    Session.prototype.playerize = function() {
      this.playerMode = true;
      return $("#session" + this.model.id).html(this.player(this.model.attributes));
    };
...
(function() {
  ...
  CurrentSessions.Routers.MainRouter = (function(_super) {
    __extends(MainRouter, _super);

    function MainRouter() {
      this.contactPage = __bind(this.contactPage, this);
      this.sessionsFetched = __bind(this.sessionsFetched, this);
      this.sessionsPage = __bind(this.sessionsPage, this);
    ...
    MainRouter.prototype.sessionsPage = function() {
      ...
      if (this.videos === void 0) {
        this.videos = new CurrentSessions.Collections.Videos();
      }
      if (!(this.videos.models.length > 0)) {
        return this.videos.fetch({
          success: this.sessionsFetched
        });
      }
    };

    MainRouter.prototype.sessionsFetched = function(collection) {
      var container, data, intervalID, item, page, video, _i, _j, _len, _len1, _ref1, _ref2,
        _this = this;
      this.viewCol = {};
      ...
      intervalID = setInterval((function() {
        ...
        return $(".session-cell").eq(num).carousel({
          interval: false
        });
      }), 5000);
      container = document.querySelector('.masonry');
      return eventie.bind(container, 'click', function(event) {
        var id, loc;
        ...
        _.each(_.values(_this.viewCol), function(v) {
          if (v.playerMode) {
            v.cellerize();
          }
          return $("#session" + v.model.id).removeClass("gigante");
        });
        classie.toggle(loc[0], 'gigante');
        _this.viewCol[id].playerize();
        return $('#sessions-container').masonry();
      });
    };

    MainRouter.prototype.contactPage = function() {
      this.page = new CurrentSessions.Views.Contact();
      return $("#contact-container").html(this.page.render().el);
    };
